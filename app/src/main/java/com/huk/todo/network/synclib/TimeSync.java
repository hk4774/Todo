...
public abstract class TimeSync {
    public static final String META_DATA_NAME = "com.huk.todo.network.synclib.TimeSync";
     ...
     * #onCreate(Context)}. The returned configuration is read-only. To edit, use
     * {@link #edit(Edit...)} instead.
     *
     ...
     * this is in {@link #onCreate(Context)}. Any modifications to {@link
     * #edit(Edit...)} will take precedence. This is equivalent to setting the
